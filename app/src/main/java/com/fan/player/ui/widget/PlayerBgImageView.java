...
public class PlayerBgImageView extends ImageView {
    ...
    public PlayerBgImageView(Context context) {
        this(context, null);
    }

    public PlayerBgImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PlayerBgImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PlayerBgImageView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = PlayerBgImageView.this.getWidth();
            final int viewHeight = PlayerBgImageView.this.getHeight();
