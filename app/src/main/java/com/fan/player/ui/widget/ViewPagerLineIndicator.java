...
public class ViewPagerLineIndicator extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFF2A93DD;
    private int underlineColor = 0x00000000;
    private int dividerColor = 0x00000000;
    private int textSelectedColor = 0xFF2A93DD;
    private int textUnselectColor = 0xFF999999;
    ...
    private float indicatorHeight = 2.2f;
    private float underlineHeight = 0.0f;
    private int dividerPadding = 12;
    private int tabPadding = 35;
    private int dividerWidth = 1;
    private int lastScrollX = 0;
	private int tabPaddingWidth = 30;
    ...
    public ViewPagerLineIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    private class TabView extends RelativeLayout {
        ...
        private void init() {
            ...
            mTabText.setGravity(Gravity.CENTER_VERTICAL);
            mTabText.setPadding(tabPaddingWidth, 0, tabPaddingWidth, 0);
            LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
	...
	public void addTab(final int position, String title) {
        ...
        tab.setBackground(getContext().getResources().getDrawable(R.color.white));
    ...
    private void tabSelect(int index) {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if(isSelected) {
                ...
                ((TabView) child).getTextView().getPaint().setFakeBoldText(true); 
            } else {
                ((TabView) child).getTextView().setTextColor(textUnselectColor);
                ((TabView) child).getTextView().getPaint().setFakeBoldText(false);
            }
        }
    }
