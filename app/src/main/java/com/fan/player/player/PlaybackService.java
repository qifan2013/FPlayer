...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private static final String ACTION_PLAY_TOGGLE = "com.fan.player.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "com.fan.player.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "com.fan.player.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "com.fan.player.ACTION.STOP_SERVICE";
